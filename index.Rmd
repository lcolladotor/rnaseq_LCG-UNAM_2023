...
* Friday February 3:
  ...
  - 12-2 pm: review + _R/Bioconductor-powered Team Data Science_ overview
  - 2-2:30 pm: open discussion (career paths, networking, etc)
...
* Public work
  - (main evidence) Taking notes on GitHub following the structure from [LieberInstitute/template_project](https://github.com/LieberInstitute/template_project)
