...
Una vez que termines, agrega la liga al repositorio con tus notas del curso en el [la página del curso](https://cursos.lcg.unam.mx/course/view.php?id=161#section-3).

## Material del curso

* Pueden descargar la versión estática con `usethis::use_course('lcolladotor/rnaseq_LCG-UNAM_2023')`
* Pueden verlo en línea a través de  [**lcolladotor.github.io/rnaseq_LCG-UNAM_2023**](http://lcolladotor.github.io/rnaseq_LCG-UNAM_2023)
...
* Comparte tu repositorio vía el Slack de la CDSB en el canal [`intro_rnaseq_lcg_2023`](https://comunidadbioinfo.slack.com/archives/C04LYBTLC22).
